package vn.thuong.jobhunter.config;
...
import vn.thuong.jobhunter.util.error.PermissionException;
        ...
        if (email != null && !email.isEmpty()) {
            ...
            if (user != null) {
                ...
                if (role != null) {
                    ...
                    if (isAllow == false) {
                        throw new PermissionException("Bạn không có quyền truy cập tài nguyên này");
