...
import vn.thuong.jobhunter.domain.request.ReqLoginDTO;
import vn.thuong.jobhunter.domain.response.ResLoginDTO;
...
public class AuthController {
    ...
    public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDTO) {
        ...
        SecurityContextHolder.getContext().setAuthentication(authentication); // để tạm
        ...
        // create access token
        String acccess_token = this.securityUtil.createAccessToken(authentication.getName(), res.getUser());

        res.setAccessToken(acccess_token);
    ...
    public ResponseEntity<ResLoginDTO> getRefreshToken(
        ...
        // check valid
        Jwt decodedToken = this.securityUtil.checkVailidRefreshToken(refresh_token);
        ...
        String acccess_token = this.securityUtil.createAccessToken(email, res.getUser());
